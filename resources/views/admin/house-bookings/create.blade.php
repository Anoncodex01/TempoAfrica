...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Create House Booking</h1>
            <p class="text-gray-600 mt-2">Add a new house information access booking</p>
        </div>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow p-6">
            <form method="POST" action="{{ route('admin.house-bookings.store') }}" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="payment_token" name="payment_token" value="{{ old('payment_token') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="url" id="payment_url" name="payment_url" value="{{ old('payment_url') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="url" id="receipt_url" name="receipt_url" value="{{ old('receipt_url') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div>
                        ...
                        <input type="text" id="receipt_filename" name="receipt_filename" value="{{ old('receipt_filename') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
...
<script>
// Auto-generate reference when form is submitted
document.querySelector('form').addEventListener('submit', function(e) {
    // The reference will be generated on the server side
