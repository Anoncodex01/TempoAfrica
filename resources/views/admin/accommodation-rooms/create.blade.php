...
<main class="flex-1 p-4 md:p-6 bg-gradient-to-br from-gray-50 to-gray-100">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-900 mb-1">Create New Room</h1>
                <p class="text-sm text-gray-600">Add a new room to an accommodation</p>
            </div>
        ...
        <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-[#d71418]/5 to-[#f19e00]/5">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-600">Fill in the details below to create a new room</p>
                </div>
            </div>
        </div>

        <form method="POST" action="{{ route('admin.accommodation-rooms.store') }}" enctype="multipart/form-data" class="p-6">
            @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="per_night" {{ old('price_duration') == 'per_night' ? 'selected' : '' }}>Per Night</option>
                            <option value="per_week" {{ old('price_duration') == 'per_week' ? 'selected' : '' }}>Per Week</option>
                            <option value="per_month" {{ old('price_duration') == 'per_month' ? 'selected' : '' }}>Per Month</option>
                        </select>
            ...
            <!-- Photo Upload -->
            <div class="mt-6">
                <h3 class="text-sm font-semibold text-gray-900 border-b border-gray-200 pb-2 mb-4">Room Photos</h3>
                ...
                <div class="mb-4">
                    ...
                    >
                    <p class="text-xs text-gray-500 mt-1">Upload a main photo for the room (max 2MB)</p>
                    @error('photo')
                        <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                    @enderror
                </div>
